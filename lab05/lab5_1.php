...
<body>
	...
	<fieldset>
		...
		<form action="lab5_1.php" method="get">
			Nhập x1:<input type="text" name="mod" value="product"><br>
			Nhập x2:<input type="text" name="ac" value="detail"><br>
			Nhập y:<input type="text" name="id" value="1"><br>
			<input type="submit">
		</form>
	</fieldset>
	...
	<fieldset>
		...
		<form action="lab5_1.php" method="get">
			Nhập x1:<input type="text" name="mod" value="product"><br>
			Nhập x2:<input type="text" name="ac" value="list"><br>
			Nhập y:<input type="text" name="name" value="a"><br>
			Nhập z:<input type="text" name="page" value="2"><br>
			<input type="submit">
		</form>
	</fieldset>
